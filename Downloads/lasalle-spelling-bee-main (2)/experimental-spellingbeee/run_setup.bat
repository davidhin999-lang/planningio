@echo off
REM Script para configurar dos ramas: main (estable) y project-apollo (experimentos)
...
REM PASO 1: Commit versión limpia en main
echo [PASO 1] Committing cleaned version to main...
cd /d c:\Users\HP\Documents\lasalle-spelling-bee
...
REM PASO 2: Crear rama project-apollo desde main
...
echo.
echo Proximos pasos:
echo 1. Restaurar sonidos en rama project-apollo
echo 2. Proteger rama main en GitHub
echo 3. Testear ambas ramas localmente
echo.
pause
